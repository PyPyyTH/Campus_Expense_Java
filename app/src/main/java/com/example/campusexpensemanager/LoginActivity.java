...
public class LoginActivity extends AppCompatActivity {
    ...
    private boolean checkLogin(String studentid, String password) {
        ...
        String[] projection = {
                AccountDB.COLUMM_STUDENTID,
                AccountDB.COLUMM_PASSWORD
        };

        String selection = AccountDB.COLUMM_STUDENTID + " = ? ";
        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                String stroredPassword = cursor.getString(cursor.getColumnIndexOrThrow(AccountDB.COLUMM_PASSWORD));
