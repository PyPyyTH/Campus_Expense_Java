...
public class ExpenseAdapter extends RecyclerView.Adapter<ExpenseAdapter.ExpenseViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ExpenseViewHolder holder, int position) {
        ...
        holder.textExpenseAmount.setText(expense.getAmount() + " VND");
        holder.textExpenseDate.setText(expense.getDate());

        holder.buttonEditExpense.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder.buttonDeleteExpense.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
