...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                account.setFullname(fullnameET.getText().toString());
                account.setStudentId(studentidET.getText().toString());
    ...
    private void saveToDatabase(Account account) {
        ...
        values.put(AccountDB.COLUMM_FULLNAME, account.getFullname());
        values.put(AccountDB.COLUMM_STUDENTID, account.getStudentid());
        values.put(AccountDB.COLUMM_EMAIL, account.getEmail());
        values.put(AccountDB.COLUMM_PASSWORD, account.getPassword());
